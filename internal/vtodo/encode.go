...
func BuildVCalendar(
	...
	for _, t := range tasks {
		...
		cal.Append(buildTaskComponent(t, o.uidDomain, statusDefs))
	}
...
func buildTaskComponent(t *core.Task, domain string, statusDefs []config.StatusDefinition) vstar.Component {
