...
* **cli:** add --no-prompt persistent flag to TaskCmd ([1e3df48](https://github.com/hop-top/tlc/commit/1e3df48bf4fc7f43efd614f63bb70b655abc51bc))
...
* **cli:** add resolveTaskIDs helper with regex/glob support and confirmBatch ([eb2f069](https://github.com/hop-top/tlc/commit/eb2f069f33d68de0116f9984f84833375877949a))
...
* **cli:** assign takes &lt;assignee&gt; first, supports multiple IDs and regex ([695ebab](https://github.com/hop-top/tlc/commit/695ebab0c984cd6c300e01ee3d7f8f3a6cd4684b))
* **cli:** batch claim/unclaim/complete/reopen/unassign via multiple IDs or regex ([0c3f47d](https://github.com/hop-top/tlc/commit/0c3f47d61528179e6b29856ecf347d281e99a1e0))
* **cli:** batch update/delete via multiple IDs or regex ([b12f5b0](https://github.com/hop-top/tlc/commit/b12f5b04f0361ca52cf5b924b4e204a696a032da))
...
* **cli:** clear Selected style and force TrueColor in tests ([f2f2491](https://github.com/hop-top/tlc/commit/f2f2491b4ed91b6f779aa21bf3f53342636a95ff))
...
* **cli:** strip ANSI from table cells to prevent ID truncation in rows 3+ ([0012892](https://github.com/hop-top/tlc/commit/001289235a128cf2f1bc6106f8751b4a2c75a857))
...
* **tui:** remove Initializing guard that blocked render before WindowSizeMsg ([0729861](https://github.com/hop-top/tlc/commit/0729861b23f58a7997682ee3999410ce80719c83))
* **tui:** remove WithMouseCellMotion to fix unresponsive key bindings ([7edea1c](https://github.com/hop-top/tlc/commit/7edea1cfd36f52bb8538b94c0d7e14dffe75b67d))
* **tui:** request window size on init to prevent stuck Initializing screen ([352debb](https://github.com/hop-top/tlc/commit/352debb8dce93133c211f9388b9fcd0ec77f95d8))
